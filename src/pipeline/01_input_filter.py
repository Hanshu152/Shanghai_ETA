...
PRED_DATA_DIR = XGBOOST_DIR / "data" / "pred_data" / "630"
...
OUTPUT_FILE = PRED_DATA_DIR / "input_filtered.csv"
REPORT_FILE = PRED_DATA_DIR / "input_filter_report.csv"
...
MIN_DOWNSTREAM_PROGRESS_KM = -3

# 连续投影里程增量中，正向增量占比至少达到该阈值
MIN_DOWNSTREAM_POSITIVE_RATIO = 0.0
