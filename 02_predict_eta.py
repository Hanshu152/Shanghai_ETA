...
INPUT_FILE = BASE_DIR / "input_filtered.csv"
...
OUTPUT_ALL_FILE = BASE_DIR / "eta_predictions_all.csv"
DAILY_OUTPUT_TEMPLATE = "eta_predictions_arrive_{date}.csv"
...
def export_daily_prediction_files(result):
    ...
    for offset in [0, 1]:
        ...
        output_file = BASE_DIR / DAILY_OUTPUT_TEMPLATE.format(date=day_text)
...
def main():
    ...
    if ais_df.empty:
        ...
        export_daily_prediction_files(empty_result)
    ...
    export_daily_prediction_files(result)
